...
module.exports.run = async function ({ api, event, args }) {
  try {
    ...
    if (mention.length !== 1) {
      api.sendMessage('Please mention one girl to impress or you like.', event.threadID, event.messageID);
      return;
    }
    ...
    const pickupLines = [
      ...
      "Parang traffic light ka—kasi tumitigil ako tuwing nakikita kita.",
